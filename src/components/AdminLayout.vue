  ...
  <el-container class="admin-layout">
      ...
      >
        ...
        <el-sub-menu index="6">
          <template #title>
            ...
            <span style="color:#ffffff;">审核与评审中心</span>
          </template>
          <el-menu-item index="6-1">异议评审管理</el-menu-item>
        ...
        <el-sub-menu index="7">
          <template #title>
            ...
            <span style="color:#ffffff;">公示与通报中心</span>
          </template>
          <el-menu-item index="7-1">成绩数据汇总</el-menu-item>
          <el-menu-item index="7-2">结果公示推送</el-menu-item>
        </el-sub-menu>
    ...
    <el-container class="admin-main-wrapper">
      ...
      <el-main class="admin-main-content">
        ...
        <div v-else-if="activeMenu === '6-1'" class="content-wrapper">
          <DisputeReview />
        </div>

        <div v-else-if="activeMenu === '7-1'" class="content-wrapper">
          <AnnouncementCenter />
        </div>

        <div v-else-if="activeMenu === '7-2'" class="content-wrapper">
          <ResultPublicity />
        </div>

        <div v-else-if="activeMenu && !['2-1', '6-1', '7-1', '7-2'].includes(activeMenu)" class="placeholder-wrapper">
...
import ResultPublicity from './ResultPublicity.vue';
import DisputeReview from './DisputeReview.vue';
...
const currentBreadcrumb = computed(() => {
  ...
  if (activeMenu.value === '6-1') return '审核与评审中心 / 异议评审管理';
  if (activeMenu.value === '7-1') return '公示与通报中心 / 成绩数据汇总';
  if (activeMenu.value === '7-2') return '公示与通报中心 / 结果公示推送';
  return '功能建设中';
});
