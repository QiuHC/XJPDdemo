      ...
      try {
        ...
        if (res.token) {
          ...
          if (res.role === 'ADMIN') {
            ...
            ElMessage({
              message: `登录成功，欢迎来到 ${res.shopName || '服务店门户'}`,
              type: 'success',
              duration: 2000
            });
        ...
        ElMessage.error(error.response?.data?.message || '账号或密码错误 (Demo: 6666666/88888888 或 BYDGD100W/88888888)');
      } finally {
        loading.value = false;
      }
    }
